...
class _CRG(Module):
    def __init__(self, platform, clk_freq):
        ...
        reset = ~platform.request("pano_button", 0)
        ...
        clk = platform.request("ddram_clock_a")
...
soc_pano_g2_argdict = soc_sdram_argdict


def main():
    parser = argparse.ArgumentParser(description="MiSoC port to the Mimas V2")
    builder_args(parser)
    soc_pano_g2_args(parser)
    args = parser.parse_args()

    soc = BaseSoC(**soc_pano_g2_argdict(args))
